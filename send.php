<?php
  ...
  if(mail('ireneuszgaslawski@gmail.com', 'witaj', 'oto funkcja maila')){
    ...
    $_SESSION['alert'] = '<div class="alert alert-success" style="position: absolute; top:76px; right:0; z-index:101;">
    ...
    $_SESSION['alert'] = '<div class="alert alert-danger" style="position: absolute; top:76px; right:0; z-index:101;">
